<!-- <form name="feedback" method="post">
	...
	<button type="submit" value="Edit">Log out</button>
</form>

<form name="feedback" method="post">
    <input type="hidden" name="profile">
	<button type="submit" value="Edit">Go to profile</button>
</form> -->
<!doctype html>
...
<h1 class = "center">                     Welcome to The Wall</h1>
<div class="d-flex gap-2 justify-content-center py-5">
<form name="feedback" method="post">
    <input type="hidden" name="logout">
    <button class="btn btn-primary rounded-pill px-3" type="submit" value="Edit">Log out</button>
</form>
<form name="feedback" method="post">
    <input type="hidden" name="profile">
    <button class="btn btn-primary rounded-pill px-3" type="submit" value="Edit">Profile</button>
</form>
<form name="feedback" method="post">
...
<form action="https://localhost/post">
    <input type="hidden" name="profile">
    <button class="btn btn-primary rounded-pill px-3" type="submit" value="Edit">Posts</button>
</form>
